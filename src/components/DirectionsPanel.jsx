...
import { MapPin, ArrowLeft, ArrowDownUp, Locate, X, Mic, MicOff } from "lucide-react";
  ...
  return (
    <div className="w-full">
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-lg font-semibold text-gray-800 dark:text-white">Directions</h2>
      </div>
      ...
      <div className="mb-4">
        <div className="relative">
          <input
            ...
            className="w-full pl-10 pr-20 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-colors"
          />
          ...
          <button
            ...
            title="Voice input for start location"
          >
      ...
      <div className="relative left-1/2 -top-1">
        <div className="absolute -left-2 top-1/2 transform -translate-y-1/2 z-10">
          <button
            ...
            className={`bg-white dark:bg-gray-700 rounded-full p-1 border border-gray-200 dark:border-gray-600 transition ${
              isSwapped ? "rotate-180" : ""
            }`}
            title="Swap locations"
          >
            <ArrowDownUp size={25} className="text-gray-600 dark:text-gray-300" />
          </button>
        </div>
      </div>
